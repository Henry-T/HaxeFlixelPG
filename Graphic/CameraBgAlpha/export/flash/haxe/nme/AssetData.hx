...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/img/blend.png", nme.NME_assets_img_blend_png);
			type.set ("assets/img/blend.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/img/bg.png", nme.NME_assets_img_bg_png);
			type.set ("assets/img/bg.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/img/starburst.png", nme.NME_assets_img_starburst_png);
			type.set ("assets/img/starburst.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_img_blend_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_img_bg_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_img_starburst_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
